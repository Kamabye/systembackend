...
@EnableJpaRepositories(basePackages = "com.herokuapp.kamabye.repository.postgresql", entityManagerFactoryRef = "entityManagerFactoryPostgreSQL", transactionManagerRef = "transactionManagerPostgreSQL")
public class PostgreSQLConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		factory = builder.dataSource(dataSource).packages("com.herokuapp.kamabye.models.postgresql")
