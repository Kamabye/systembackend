...
public interface UserRepository extends JpaRepository<Usuario, Long> {
	...
	@Query("SELECT new com.herokuapp.kamabye.models.dto.UsuarioDTO( u ) FROM Usuario u")
	Page<UsuarioDTO> jpqlfindAllUsuariosDTOPageable(Pageable pageable);

	@Query("SELECT new com.herokuapp.kamabye.models.dto.UsuarioDTO(u.id, u.nombres) FROM Usuario u")
	List<UsuarioDTO> jpqlObtenerUsuariosDTO();

	@Query("SELECT new com.herokuapp.kamabye.models.dto.UsuarioDTO(u.id, u.nombres) FROM Usuario u WHERE u.nombres = :nombres")
