...
@EnableJpaRepositories(basePackages = "com.system.domain.repository.postgresql", entityManagerFactoryRef = "entityManagerFactoryPostgreSQL", transactionManagerRef = "transactionManagerPostgreSQL")
